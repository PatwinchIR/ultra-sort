...
template void MergePass8<int, __m256i>(int *&arr, int *buffer, size_t N, int run_size);
template void MergePass8<float, __m256>(float *&arr, float *buffer, size_t N, int run_size);
...
template void MaskedMergePass8<int, __m256i>(int *&arr, int *buffer, size_t N, int run_size);
template void MaskedMergePass8<float, __m256>(float *&arr, float *buffer, size_t N, int run_size);
...
template void MergePass4<int64_t, __m256i>(int64_t *&arr, int64_t *buffer, size_t N, int run_size);
template void MergePass4<double, __m256d>(double *&arr, double *buffer, size_t N, int run_size);
...
template void MaskedMergePass4<int64_t, __m256i>(int64_t *&arr, int64_t *buffer, size_t N, int run_size);
template void MaskedMergePass4<double, __m256d>(double *&arr, double *buffer, size_t N, int run_size);
}
