...
template <typename T>
void AVX256MergeUtil::MaskedIntraRegisterSort8x8(T &a4kv, T &b4kv) {
  // Level 1
  AVX256Util::MaskedMinMax8(a4kv, b4kv);
...
template void AVX256MergeUtil::MaskedIntraRegisterSort8x8<__m256i>(__m256i &a, __m256i &b);
template void AVX256MergeUtil::MaskedIntraRegisterSort8x8<__m256>(__m256 &a, __m256 &b);

template <typename T>
void AVX256MergeUtil::IntraRegisterSort4x4(T &a4, T &b4) {
  // Level 1
...
template void AVX256MergeUtil::IntraRegisterSort4x4<__m256i>(__m256i &a, __m256i &b);
template void AVX256MergeUtil::IntraRegisterSort4x4<__m256d>(__m256d &a, __m256d &b);
...
template <typename T>
void AVX256MergeUtil::MaskedBitonicMerge8(T &a, T &b) {
  b = AVX256Util::MaskedReverse8(b);
  MaskedIntraRegisterSort8x8(a,b);
}

template void AVX256MergeUtil::MaskedBitonicMerge8<__m256i>(__m256i &a, __m256i &b);
template void AVX256MergeUtil::MaskedBitonicMerge8<__m256>(__m256 &a, __m256 &b);
...
template <typename InType, typename RegType>
void AVX256MergeUtil::MaskedMergeRuns8(InType *&arr, int N) {
  InType* buffer;
  int UNIT_RUN_SIZE=8;
  aligned_init(buffer, N);
  for(int run_size = UNIT_RUN_SIZE; run_size < N; run_size*=2) {
...
template void AVX256MergeUtil::MaskedMergeRuns8<int,__m256i>(int *&arr, int N);
template void AVX256MergeUtil::MaskedMergeRuns8<float,__m256>(float *&arr, int N);
...
template <typename InType, typename RegType>
void AVX256MergeUtil::MaskedMergePass8(InType *&arr, InType *buffer, int N, int run_size) {
  int UNIT_RUN_SIZE=8;
  RegType ra, rb;
  int buffer_offset = 0;
  for(int i = 0; i < N; i += 2*run_size) {
...
template void AVX256MergeUtil::MaskedMergePass8<int,__m256i>(int *&arr, int *buffer, int N, int run_size);
template void AVX256MergeUtil::MaskedMergePass8<float,__m256>(float *&arr, float *buffer, int N, int run_size);
