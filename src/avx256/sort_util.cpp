...
template <typename T>
void AVX256SortUtil::MaskedBitonicSort4x8(T &r0,
                                          T &r1,
                                          T &r2,
                                          T &r3) {
...
template void AVX256SortUtil::MaskedBitonicSort4x8<__m256i>(__m256i&, __m256i&, __m256i&, __m256i&);
template void AVX256SortUtil::MaskedBitonicSort4x8<__m256>(__m256&, __m256&, __m256&, __m256&);
...
template <typename InType, typename RegType>
void AVX256SortUtil::MaskedSortBlock4x8(InType *&arr, int offset) {
  int ROW_SIZE = 8;
  // Put into registers
  RegType r0, r1, r2, r3;
  ...
  // Apply bitonic sort
  AVX256SortUtil::MaskedBitonicSort4x8(r0, r1, r2, r3);
...
template void AVX256SortUtil::MaskedSortBlock4x8<int, __m256i>(int *&arr, int offset);
template void AVX256SortUtil::MaskedSortBlock4x8<float, __m256>(float *&arr, int offset);
