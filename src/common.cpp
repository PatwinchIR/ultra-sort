...
template void aligned_init<std::pair<int64_t,int64_t>>(std::pair<int64_t,int64_t>* &ptr, int N, size_t alignment_size);
template void aligned_init<std::pair<float,float>>(std::pair<float,float>* &ptr, int N, size_t alignment_size);
template void aligned_init<std::pair<double,double>>(std::pair<double,double>* &ptr, int N, size_t alignment_size);
